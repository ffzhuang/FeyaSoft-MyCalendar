...
Ext.ux.calendar.editor.CalendarEditor = function(config){
	...
	Ext.ux.calendar.editor.CalendarEditor.superclass.constructor.call(this, {		
		items:[{
			border:false,
			layout:'fit',
...
Ext.extend(Ext.ux.calendar.editor.CalendarEditor, Ext.Window, {
    width:500,
